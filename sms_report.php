					...
					<div class="card">
						<div class="header">
							<h4 class="title">
								...
								<a href="sms_report.php" style="float:right !important" class="btn btn-primary">Reset Search</a>
							</h4>
						...
						<div class="content table-responsive table-full-width">
							<form style="margin: 0 5px 0 10px;">
								<div class="row">
									<div class="col-md-5">
										<input type="text" name="search" id="search" class="form-control" placeholder="Search by phone, text, sid" />
										...
										<select name="direction" id="direction" class="form-control">
											...
											<option <?php
													if (isset($_REQUEST['direction']))
														if ($_REQUEST['direction'] == "in-bound") {
															echo "selected";
														} ?> value="in-bound">In-bound</option>
											<option <?php
													if (isset($_REQUEST['direction']))
														if ($_REQUEST['direction'] == "out-bound") {
															echo "selected";
										...
										<select name="is_sent" id="is_sent" class="form-control">
											...
											<option <?php
													if (isset($_REQUEST['is_sent']))
														if ($_REQUEST['is_sent'] == "true") {
															echo "selected";
														} ?> value="true">Delivered</option>
											<option <?php if (isset($_REQUEST['is_sent']))
														if ($_REQUEST['is_sent'] == "false") {
															echo "selected";
...
WHERE users.id=" . $_SESSION['user_id']))['id'];
			...
			<tr>
				...
				<td style="padding-left:0px !important;padding-right:0px !important"><?php echo $pages['pagingString']; ?></td>
