...
<script src="js/jquery-ui-1.10.0.custom.js"></script>
 ...
 <script type="text/javascript" src="https://maps.google.com/maps/api/js?key=AIzaSyCc9MOpE2wArUTUcA67RHFfpI-BfIHrDCs&sensor=false"></script>
					...
					<div class="card">
						...
						<div class="content table-responsive">
                            ...
                            <button class="button" onclick="return ajaxFileUpload('slider_image_0','loading_0','uploaded_thumb_0','image');" style="margin-top: 5px;">Upload</button>
                                      ...
                                      <div id="map_0" style="display: none;">
                                          <input type="hidden" name="lat" value="<?php echo @$obj['settings_0']['lat']?>"/>
                                        ...
                                        <div id="slider_map_<?php echo $map?>" class="slider_area">
                                             <table width="100%" border="0" align="center">
                                              ...
                                              Enter Address: <small>(Enter address, then drag red marker on location to get exact address)</small>
                                                <textarea name="address"  class="text_feild_cam map_address"  id="map_address_<?php echo $map;?>" onfocus="load_map('<?php echo $map?>')" style="width: 100%; height: 70px;"><?php echo $obj[$key]['address']?></textarea>
                                                   <div id="wrapper_<?php echo $map?>" style="margin-left: 00px; margin-top: 10px;  position: absolute; display: none; z-index: 1;">
                                                       <div id="map_div_<?php echo $map?>" style="border: 5px solid #ccc; width: 550px; height: 400px; background-color: #e2e2e2; overflow: hidden;"></div>
                                                       <img alt="" src="images/close_buttonc.png" style=" cursor: pointer; z-index: 2; position: absolute;" id="close_map_<?php echo $map?>" class="close_map"/>
                                                   </div>
