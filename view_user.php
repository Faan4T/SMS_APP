					...
					<div class="card">
						<div class="header">
							<h4 class="title">
								...
								<input style="float: right!important;" type="button" class="btn btn-primary" value="Add New" onclick="window.location='add_app_user.php'" />
							</h4>
						...
						<div class="content table-responsive table-full-width">
							<div class="content">
								<div class="table-scroll">
									<table id="accountsTable" class="table table-hover table-striped listTable" style="color:#999;">
										<thead>
											<tr>
												<th>#</th>
												<th>Name</th>
										...
										<tbody>
											<?php
											$sql = sprintf(
												"select * from users where parent_user_id=%s and type='2' order by id desc",
											...
											?>
													<tr>
														...
														<td><?php echo DBout($row['Client']); ?></td>
														<td>
															<?php
															$sel = sprintf(
																"select pp.title from package_plans pp, user_package_assignment upa where upa.pkg_id=pp.id and upa.user_id=%s ",
...
<script src="scripts/view_user.js">
</script>