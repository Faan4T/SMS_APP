...
CREATE TABLE `application_settings` (
  ...
  `footer_customization` longtext COLLATE utf8_unicode_ci,
  `enable_whatsapp` int(11) NOT NULL DEFAULT '0',
  `is_double_optin` tinyint(4) NOT NULL DEFAULT '0',
  `signalwire_space_url` text COLLATE utf8_unicode_ci,
  `signalwire_project_key` longtext COLLATE utf8_unicode_ci,
  `signalwire_token` longtext COLLATE utf8_unicode_ci
...
CREATE TABLE `appointment_templates` (
  ...
  `immediate_sms` longtext CHARACTER SET utf8,
  `immediate_sms_media` longtext CHARACTER SET utf8,
...
CREATE TABLE `campaigns` (
  ...
  `code_message` text COLLATE utf8_unicode_ci,
  `notification_msg` text COLLATE utf8_unicode_ci,
  `winning_number` int(11) NOT NULL DEFAULT '0',
  `winner_msg` text COLLATE utf8_unicode_ci,
  `looser_msg` text COLLATE utf8_unicode_ci,
  `correct_sms` text COLLATE utf8_unicode_ci,
  `wrong_sms` text COLLATE utf8_unicode_ci,
  `complete_sms` text COLLATE utf8_unicode_ci,
...
CREATE TABLE `template_reminders` (
  ...
  `sms_text` longtext CHARACTER SET utf8,
...
CREATE TABLE `users_phone_numbers` (
  ...
  `type` int(11) NOT NULL DEFAULT '1' COMMENT '1 for twilio, 2 for plivo, 3 for nexmo, 4 for whatsapp, 5 for signalwire, 6 for tele api',
  `user_id` int(11) NOT NULL DEFAULT '0',
  `created_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
