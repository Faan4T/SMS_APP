					...
					<div class="card">
						<div class="header">
							<h4 class="title">Keyword Campagins
								<input type="button" class="btn btn-primary move-right" value="Add New" onclick="window.location='add_campaign.php'" />
							</h4>
							<p class="category">Your already saved list of campaigns.</p>
							<div id="alertArea"></div>
						</div>
                        <?php
                       $sql_campaign = mysqli_query($link,sprintf("select * from campaigns where user_id=%s and type='1'",
                        ...
                        <div class="content table-responsive table-full-width">
							...
							<table id="campaignTable" class="table table-hover table-striped listTable">
								...
								<tbody>
									<?php
										$sql = sprintf("select * from campaigns where user_id=%s and type='1' order by id desc",
                                                        mysqli_real_escape_string($link,filterVar($_SESSION['user_id']))
                                            );
                                    if(isset($_REQUEST['search']) && $_REQUEST['search'] != ''){
