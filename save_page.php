...
/////////////////////////////////////
 ...
 { $json=mysqli_real_escape_string($con,$json);
    $sql="insert into pages(json,page_key,created_user,lat,lng,redeem_limit,page_title,refresh_rate,redeem_once,redeem_page_id,created_date,modified_date,short_url) values('$json','$_POST[page_key]','".$_SESSION['user_id']."','$lat','$lng','$red_limit','$title','$refresh_rate','$redeem_once','$redeem_page_id',Now(),Now(),'')";
