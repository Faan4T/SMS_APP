                                        ...
                                        <div class="panel-collapse sms_texts_section display-block" aria-expanded="true">
                                            <div class="portlet-body padding-10">
                                                ...
                                                <div class="form-group">
													...
													<span class="showCount"><?php echo DBout($maxLength-strlen($row['winner_msg']))?></span> Characters left
												</span>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <span class="showCounter">
													<span class="showCount"><?php echo DBout($maxLength-strlen($row['looser_msg']))?></span> Characters left
												</span>
                                                </div>
