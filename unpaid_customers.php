                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="header">
                            ...
                            <p class="category">List of UnPaid customers.</p>
                        </div>
                        <?php

                        $sql_subscribers = mysqli_query($link,sprintf("select * from subscribers s, subscribers_group_assignment sga where s.id = sga.subscriber_id and sga.payment_status = 0 and s.user_id = %s",
                        ...
                        <div class="content table-responsive table-full-width">
                            ...
                            <table id="subscribersTable" class="table table-hover table-striped listTable margin-right-200">
                                ...
                                $where = "where s.user_id='".DBout($_SESSION['user_id'])."' and s.id=sga.subscriber_id and sga.group_id=c.id and sga.payment_status = 0";
                                ...
                                $pagelink 	= "unpaid_customers.php?search=".$_REQUEST['search']."&group_id=".$_REQUEST['group_id']."&";
