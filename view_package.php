				...
				<div class="col-md-12">
					<div class="card">
						<div class="header">
							<h4 class="title">
								Pricing Plans
								<input style="float: right!important;" type="button" class="btn btn-primary move-right" value="Add New" onclick="window.location='add_package.php'" />
							</h4>
								...
								<div class="table-scroll">
									<table id="packagesTable" class="table table-hover table-striped listTable">
										...
										<tbody>
											<?php
											$sql = sprintf(
												"select * from package_plans where user_id=%s ",
											...
											?>
												...
												<tr>
													<td colspan="7">No plan created yet.</td>
												</tr>
											<?php	}
											?>
										</tbody>
