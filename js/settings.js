...
function buySignalWireNumber(){
	...
	$.post("server.php",{"cmd":"buy_signalwire_number",phoneNumber:phoneNumber},function(r){
...
$('.smsGateWay').on('change',function(r){
	...
	}else if($(this).val()=='trumpia'){
		$('.trumpiaInfo').show('slow');
	}
});
